...
document.getElementById("generarBtn").addEventListener("click", function () {
  ...
  function crearElementos(svg, cantidad, tamanoElemento, clases, colores, ancho, largo, pasilloWidth) {
    ...
    for (let i = 0; i < cantidad; i++) {
      ...
      if (i === 3) {
        dibujarElementoCama(svg, tamanoElemento[3], clases[3], "red", x, y);
      }
      if (i === 1) {
        dibujarElementoMesa(svg, tamanoElemento[i], clases[i], "red", x, y);
      }
    }
  }
  ...
  function crearElemento2(svg, cantidad, tamanoElemento, clases, colores, ancho, largo, pasilloWidth) {
    ...
    for (let i = 0; i < cantidad; i++) {
      ...
      dibujarElemento(svg, tamanoElemento[i], clases[i], colores[i], x, y);
      if (i === 3 || i=== 5) {
        dibujarElementoCama(svg, tamanoElemento[i], clases[i], "white", x, y);
      }
      if (i === 1) {
        dibujarElementoMesa(svg, tamanoElemento[i], clases[i], "red", x, y);
      }
  ...
  function dibujarElementoCama(svg, tamanoElemento, clase, color, x, y) {
   
    // Agregar cuadrados pequeños dentro del dormitorio (pueden representar muebles, etc.)
 // Cambia el número 3 según la cantidad deseada de cuadrados
      svg.append("rect")
        .attr("x", x +  tamanoElemento.width/2 -40)
        .attr("y", y +  tamanoElemento.height/2  +10)
        .attr("width", 80)  // Ancho del cuadrado pequeño
        .attr("height", 150)  // Altura del cuadrado pequeño
        .attr("fill", "#f5e9e9") // Color del cuadrado pequeño (puedes ajustar el color)
        .attr("stroke", "black")  // Utilizar el color condicional para el borde
        .attr("stroke-width", 2);
      
  
  }
  function dibujarElementoMesa(svg, tamanoElemento, clase, color, x, y) {
 ...
 // Cambia el número 3 según la cantidad deseada de cuadrados
      svg.append("rect")
        ...
        .attr("y", y +  tamanoElemento.height/2  +10)
        .attr("width", 80)  // Ancho del cuadrado pequeño
        .attr("height", 120)  // Altura del cuadrado pequeño
        .attr("fill", "#693838") // Color del cuadrado pequeño (puedes ajustar el color)
        .attr("stroke", "black")  // Utilizar el color condicional para el borde
        .attr("stroke-width", 2);
